...
let eurToAudRate = rates.AUD // Example exchange rate from EUR to AUD
let eur = 100
...
cats_and_owners.forEach(function(owner){
    console.log(owner.name + "has a cat named " + owner.cat + ".")
})
...
//   have a good look at how the JSON is structured, and think about what loop you'll need to write.
